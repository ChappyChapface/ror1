...
public class BlueShroomThronsFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:blue_shroom_throns", CONFIGURED_FEATURE, List.of(CountPlacement.of(40), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
		return FEATURE;
	}
