...
import net.mcreator.tnunlimited.world.features.ores.PurpleStickySlimeFeature;
...
import net.mcreator.tnunlimited.world.features.SmallPalmTreeFeature;
...
import net.mcreator.tnunlimited.world.features.MedPalmTreeFeature;
import net.mcreator.tnunlimited.world.features.MedBlueShroomFeature;
import net.mcreator.tnunlimited.world.features.LargePalmTreeFeature;
...
public class TnunlimitedModFeatures {
	...
	public static final RegistryObject<Feature<?>> PURPLE_STICKY_SLIME = REGISTRY.register("purple_sticky_slime", PurpleStickySlimeFeature::feature);
