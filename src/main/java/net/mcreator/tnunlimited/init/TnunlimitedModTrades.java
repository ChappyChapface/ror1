...
public class TnunlimitedModTrades {
	...
	public static void registerWanderingTrades(WandererTradesEvent event) {
		...
		event.getGenericTrades().add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(TnunlimitedModItems.NUBRIUM.get(), 4), new ItemStack(TnunlimitedModItems.SPIKED_COLLAR.get()), 1, 5, 0.05f));
		event.getGenericTrades().add(new BasicItemListing(new ItemStack(Items.EMERALD, 16),

				new ItemStack(TnunlimitedModItems.THICK_HORSESHOE.get()), 1, 5, 0.05f));
	}
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == VillagerProfession.FARMER) {
			...
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(Blocks.OAK_LOG), new ItemStack(TnunlimitedModItems.TREE_BARK.get()), 10, 25, 0.05f));
		}
		...
		if (event.getType() == VillagerProfession.MASON) {
			event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(Items.IRON_INGOT, 5), new ItemStack(TnunlimitedModItems.EXTENDER.get()), 1, 25, 0.05f));
		}
		if (event.getType() == TnunlimitedModVillagerProfessions.MUSICIAN.get()) {
			...
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(Items.CLOCK), new ItemStack(Items.MUSIC_DISC_WAIT), 1, 25, 0.05f));
			...
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(Items.GOLD_INGOT, 16), new ItemStack(Items.MUSIC_DISC_PIGSTEP), 1, 25, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(Blocks.SUNFLOWER, 8), new ItemStack(TnunlimitedModItems.SUNRISE.get()), 1, 25, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(TnunlimitedModItems.WITHER_AND_ROT.get()), new ItemStack(TnunlimitedModItems.WITHER_AND_ROT_CHIPTUNE.get()), 1, 25, 0.05f));
			event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 64), new ItemStack(Blocks.KELP, 32), new ItemStack(TnunlimitedModItems.PLUNDER_N_BLUNDERBUSS.get()), 1, 25, 0.05f));
			...
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 64), new ItemStack(Items.CHORUS_FRUIT, 16), new ItemStack(TnunlimitedModItems.THE_DRAGON_GUARDING_THE_ABYSS.get()), 1, 25, 0.05f));
			event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 64), new ItemStack(Blocks.DEAD_FIRE_CORAL_BLOCK, 4), new ItemStack(TnunlimitedModItems.OCEAN_WASTE.get()), 1, 25, 0.05f));
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 32), new ItemStack(Blocks.DEAD_FIRE_CORAL), new ItemStack(TnunlimitedModItems.DRYOUT_DISC.get()), 1, 25, 0.05f));
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Blocks.NOTE_BLOCK),

					new ItemStack(Items.EMERALD), 1, 5, 0.05f));
		}
		if (event.getType() == TnunlimitedModVillagerProfessions.MUSICIAN.get()) {
			event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(Items.NETHERITE_INGOT), new ItemStack(TnunlimitedModItems.FERAL_HUNTING_KNIFE.get()), 1, 25, 0.05f));
		}
	}
}
