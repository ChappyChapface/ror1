...
public class ShroomOfThePurpledEntity extends Monster implements RangedAttackMob, IAnimatable {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ShroomOfThePurpledEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ShroomOfThePurpledEntity.class, EntityDataSerializers.STRING);
	...
	public ShroomOfThePurpledEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TnunlimitedModEntities.SHROOM_OF_THE_PURPLED.get(), world);
	}

	public ShroomOfThePurpledEntity(EntityType<ShroomOfThePurpledEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "shoomofthepurpled");
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((ShroomOfThePurpledEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((ShroomOfThePurpledEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TnunlimitedModItems.PURPLE_MUSHROOM.get()));
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		StickySlimeProjectileEntity.shoot(this, target);
	}
