...
public class PlayerFrostSpikeEntityEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PlayerFrostSpikeEntityEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PlayerFrostSpikeEntityEntity.class, EntityDataSerializers.STRING);
	...
	public PlayerFrostSpikeEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TnunlimitedModEntities.PLAYER_FROST_SPIKE_ENTITY.get(), world);
	}

	public PlayerFrostSpikeEntityEntity(EntityType<PlayerFrostSpikeEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		PlayerFrostSpikeAttackProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
