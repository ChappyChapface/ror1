...
import net.mcreator.tnunlimited.procedures.ZombieOnEntityTickUpdateProcedure;
...
public class ZombieEntity extends TamableAnimal {
	public ZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TnunlimitedModEntities.ZOMBIE.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ZombieOnEntityTickUpdateProcedure.execute(world, this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ZombieEntity retval = TnunlimitedModEntities.ZOMBIE.get().create(serverWorld);
