...
public class CakemonsterEntity extends Monster implements RangedAttackMob {
	...
	public CakemonsterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TnunlimitedModEntities.CAKEMONSTER.get(), world);
	}

	public CakemonsterEntity(EntityType<CakemonsterEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 24;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.CAKE));
	}
	...
	public void baseTick() {
		super.baseTick();
		CakemonsterattackProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public void performRangedAttack(LivingEntity target, float flval) {
		CakemonsterEntityProjectile entityarrow = new CakemonsterEntityProjectile(TnunlimitedModEntities.CAKEMONSTER_PROJECTILE.get(), this, this.level);
