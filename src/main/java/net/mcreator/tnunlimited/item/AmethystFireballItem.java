...
public class AmethystFireballItem extends Item {
	public AmethystFireballItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					AmethystFireballEntity entityarrow = AmethystFireballEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
