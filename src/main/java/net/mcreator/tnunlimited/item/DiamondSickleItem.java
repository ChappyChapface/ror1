...
public class DiamondSickleItem extends Item {
	public DiamondSickleItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(3122));
	}

	@Override
	public float getDestroySpeed(ItemStack itemstack, BlockState blockstate) {
		return List.of(Blocks.COCOA, Blocks.HAY_BLOCK, Blocks.MELON, Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.JACK_O_LANTERN, Blocks.OAK_LEAVES, Blocks.OAK_LEAVES, Blocks.SPRUCE_LEAVES, Blocks.BIRCH_LEAVES, Blocks.JUNGLE_LEAVES,
