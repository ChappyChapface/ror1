...
public class SpikedCollarItem extends Item {
	public SpikedCollarItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77Greatly increased Familiar stats. Greatly lowers your stats."));
	}
}
