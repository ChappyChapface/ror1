...
public class AardiumNeedleItem extends Item {
	public AardiumNeedleItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					AardiumNeedleEntity entityarrow = AardiumNeedleEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
