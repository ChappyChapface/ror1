...
public abstract class CaptainsHatItem extends ArmorItem {
	...
	public static class Helmet extends CaptainsHatItem {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelCaptainHat(Minecraft.getInstance().getEntityModels().bakeLayer(ModelCaptainHat.LAYER_LOCATION)).bb_main, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "tnunlimited:textures/entities/captainshat.png";
		}
	}
}
