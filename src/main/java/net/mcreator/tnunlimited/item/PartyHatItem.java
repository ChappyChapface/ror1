...
public abstract class PartyHatItem extends ArmorItem {
	public PartyHatItem(EquipmentSlot slot, Item.Properties properties) {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelPartyHat(Minecraft.getInstance().getEntityModels().bakeLayer(ModelPartyHat.LAYER_LOCATION)).bb_main, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
