...
public class BloodgodOrbItem extends Item {
	public BloodgodOrbItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BloodgodOrbEntity entityarrow = BloodgodOrbEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
