...
public class SoulfireSpikeItem extends Item {
	public SoulfireSpikeItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SoulfireSpikeEntity entityarrow = SoulfireSpikeEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
