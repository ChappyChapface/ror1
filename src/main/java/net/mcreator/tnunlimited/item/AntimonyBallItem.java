...
public class AntimonyBallItem extends Item {
	public AntimonyBallItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					AntimonyBallEntity entityarrow = AntimonyBallEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
