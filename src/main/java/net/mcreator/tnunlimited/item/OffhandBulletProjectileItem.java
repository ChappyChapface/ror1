...
public class OffhandBulletProjectileItem extends Item {
	public OffhandBulletProjectileItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					OffhandBulletProjectileEntity entityarrow = OffhandBulletProjectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 0);
