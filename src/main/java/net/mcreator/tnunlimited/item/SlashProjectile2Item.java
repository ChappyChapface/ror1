...
public class SlashProjectile2Item extends Item {
	public SlashProjectile2Item() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SlashProjectile2Entity entityarrow = SlashProjectile2Entity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
