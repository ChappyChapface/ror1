...
public class FrostPupaeAttackItem extends Item {
	public FrostPupaeAttackItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					FrostPupaeAttackEntity entityarrow = FrostPupaeAttackEntity.shoot(world, entity, world.getRandom(), 0.5f, 4, 0);
