...
public class HelmetFireballItem extends Item {
	public HelmetFireballItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					HelmetFireballEntity entityarrow = HelmetFireballEntity.shoot(world, entity, world.getRandom(), 1f, 3, 1);
