...
public class SlashProjectileItem extends Item {
	public SlashProjectileItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SlashProjectileEntity entityarrow = SlashProjectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
