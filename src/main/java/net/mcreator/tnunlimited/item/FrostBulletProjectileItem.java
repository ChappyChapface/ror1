...
public class FrostBulletProjectileItem extends Item {
	public FrostBulletProjectileItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					FrostBulletProjectileEntity entityarrow = FrostBulletProjectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 0);
