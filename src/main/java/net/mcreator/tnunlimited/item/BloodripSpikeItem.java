...
public class BloodripSpikeItem extends Item {
	public BloodripSpikeItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BloodripSpikeEntity entityarrow = BloodripSpikeEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
