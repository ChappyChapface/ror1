...
public class FrostburnSphereItem extends Item {
	public FrostburnSphereItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					FrostburnSphereEntity entityarrow = FrostburnSphereEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
