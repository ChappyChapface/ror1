...
public class SlothsBedtimeElixirItem extends Item {
	public SlothsBedtimeElixirItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_BREWING).stacksTo(1).rarity(Rarity.UNCOMMON).food((new FoodProperties.Builder()).nutrition(2).saturationMod(0f).alwaysEat()
