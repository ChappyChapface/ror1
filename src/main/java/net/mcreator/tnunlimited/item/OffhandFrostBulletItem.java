...
public class OffhandFrostBulletItem extends Item {
	public OffhandFrostBulletItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					OffhandFrostBulletEntity entityarrow = OffhandFrostBulletEntity.shoot(world, entity, world.getRandom(), 1f, 5, 0);
