...
public class NubriumSpikeItem extends Item {
	public NubriumSpikeItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					NubriumSpikeEntity entityarrow = NubriumSpikeEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
