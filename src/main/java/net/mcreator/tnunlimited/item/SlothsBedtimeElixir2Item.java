...
public class SlothsBedtimeElixir2Item extends Item {
	public SlothsBedtimeElixir2Item() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_BREWING).stacksTo(1).rarity(Rarity.RARE).food((new FoodProperties.Builder()).nutrition(2).saturationMod(0f).alwaysEat()
