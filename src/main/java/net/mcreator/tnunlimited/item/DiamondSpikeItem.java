...
public class DiamondSpikeItem extends Item {
	public DiamondSpikeItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					DiamondSpikeEntity entityarrow = DiamondSpikeEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
