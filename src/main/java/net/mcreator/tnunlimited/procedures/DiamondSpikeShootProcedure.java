...
public class DiamondSpikeShootProcedure {
		...
		if (2 <= (entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).mana) {
			...
			d = n * Math.sin((90 - entity.getXRot()) * (3.14159265 / 180));
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 6, (int) 0.25);
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (TnunlimitedModParticleTypes.DIAMOND_MAGIC_CIRCLE.get()), (entity.getX() + d * Math.sin((90 - (entity.getYRot() + 90)) * (3.14159265 / 180))),
