	...
	public static String execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(new ResourceLocation("forge:blunt_weapon")))) {
			if (EnchantmentHelper.getItemEnchantmentLevel(TnunlimitedModEnchantments.IMPULSIVE.get(), (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0) {
				return "Charge Time: " + new java.text.DecimalFormat("##").format(entity.getPersistentData().getDouble("bluntCharge")) + "/"
				...
				return "Charge Time: " + new java.text.DecimalFormat("##").format(entity.getPersistentData().getDouble("bluntCharge")) + "/25";
			}
			...
			return "Energy: " + new java.text.DecimalFormat("##").format((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).nitroknifecharge) + "/30";
			...
			return "Energy: " + new java.text.DecimalFormat("##").format((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).energybladecharge) + "/50";
			...
			return "Energy: " + new java.text.DecimalFormat("##").format((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).nitroclaymorecharge) + "/80";
			...
			return "Charges: " + new java.text.DecimalFormat("##").format(entity.getPersistentData().getDouble("charges")) + "/5";
		}
