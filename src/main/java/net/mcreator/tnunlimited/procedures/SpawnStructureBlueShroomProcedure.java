...
public class SpawnStructureBlueShroomProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments) {
		if (DoubleArgumentType.getDouble(arguments, "variation") == 0) {
			if (DoubleArgumentType.getDouble(arguments, "rotation") == 0 && DoubleArgumentType.getDouble(arguments, "mirror") == 0) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("tnunlimited", "2largeblueshroom"));
					if (template != null) {
		...
		} else if (DoubleArgumentType.getDouble(arguments, "variation") == 1) {
			if (DoubleArgumentType.getDouble(arguments, "rotation") == 0 && DoubleArgumentType.getDouble(arguments, "mirror") == 0) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("tnunlimited", "2medblueshroom"));
					if (template != null) {
						template.placeInWorld(_serverworld, new BlockPos(new Object() {
							public double getX() {
								try {
		...
		} else if (DoubleArgumentType.getDouble(arguments, "variation") == 2) {
			if (DoubleArgumentType.getDouble(arguments, "rotation") == 0 && DoubleArgumentType.getDouble(arguments, "mirror") == 0) {
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("tnunlimited", "2smallblueshroom"));
					if (template != null) {
						template.placeInWorld(_serverworld, new BlockPos(new Object() {
							public double getX() {
								try {
