...
public class HeartcoreEffectProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, double amount) {
		if (entity == null)
			return;
		if (world.getDifficulty() == Difficulty.HARD && (((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc00).getItem() == TnunlimitedModItems.HEARTCORE.get()
				|| ((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc01).getItem() == TnunlimitedModItems.HEARTCORE.get()
				|| ((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc02).getItem() == TnunlimitedModItems.HEARTCORE.get())) {
			if (amount >= (entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) && entity.getPersistentData().getDouble("heartcoreCooldown") <= 0) {
				...
				entity.getPersistentData().putDouble("heartcoreCooldown", 36000);
			}
		}
		if (((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc00).getItem() == TnunlimitedModItems.HOLY_RELIC.get()
				|| ((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc01).getItem() == TnunlimitedModItems.HOLY_RELIC.get()
				|| ((entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).Acc02).getItem() == TnunlimitedModItems.HOLY_RELIC.get()) {
			if (entity.getPersistentData().getDouble("holyRelicCooldown") <= 0) {
				if (event != null && event.isCancelable()) {
					event.setCanceled(true);
				}
				if (entity instanceof Player _player)
					_player.getCooldowns().addCooldown(TnunlimitedModItems.HOLY_RELIC.get(), 1200);
				entity.getPersistentData().putDouble("holyRelicCooldown", 1200);
				...
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.SCRAPE, x, y, z, 25, 1, 1, 1, 5);
			}
		}
