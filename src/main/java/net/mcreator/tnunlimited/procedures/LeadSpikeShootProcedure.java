...
public class LeadSpikeShootProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (2 <= (entity.getCapability(TnunlimitedModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new TnunlimitedModVariables.PlayerVariables())).mana) {
				...
				if (!projectileLevel.isClientSide()) {
					Projectile _entityToSpawn = new Object() {
						public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
							AbstractArrow entityToSpawn = new LeadSpikeEntity(TnunlimitedModEntities.LEAD_SPIKE.get(), level);
					...
					}.getArrow(projectileLevel, entity, 12, 1, (byte) 1);
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (TnunlimitedModParticleTypes.LEAD_MAGIC_CIRCLE.get()), (entity.getX() + d * Math.sin((90 - (entity.getYRot() + 90)) * (3.14159265 / 180))),
