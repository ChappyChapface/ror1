...
public class BossDieProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof WitherBoss || entity instanceof EnderDragon || entity instanceof KkoreulEntity || entity instanceof CakemonsterEntity || entity instanceof QueenLadyBugEntity || entity instanceof FrostAntQueenEntity
				|| entity instanceof PirateCaptainEntity) {
