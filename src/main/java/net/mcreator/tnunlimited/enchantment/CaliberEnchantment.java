...
public class CaliberEnchantment extends Enchantment {
	...
	protected boolean checkCompatibility(Enchantment ench) {
		return List.of(TnunlimitedModEnchantments.FULL_MAGIC_JACKET.get(), TnunlimitedModEnchantments.TRIGGER_HAPPY.get(), TnunlimitedModEnchantments.KICKBACK.get(), Enchantments.UNBREAKING, Enchantments.MENDING).contains(ench);
	}
