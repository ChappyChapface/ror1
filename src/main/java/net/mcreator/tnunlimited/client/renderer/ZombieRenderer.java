...
public class ZombieRenderer extends HumanoidMobRenderer<ZombieEntity, HumanoidModel<ZombieEntity>> {
	...
	public ResourceLocation getTextureLocation(ZombieEntity entity) {
		return new ResourceLocation("tnunlimited:textures/entities/berniezombiereal.png");
	}
}
