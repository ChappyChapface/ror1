...
public class ModelRedstoneTreadling<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tnunlimited", "model_redstone_treadling"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Bod = partdefinition.addOrReplaceChild("Bod",
				CubeListBuilder.create().texOffs(1, 35).addBox(-4.0F, 6.0F, -1.0F, 8.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-8.0F, -3.0F, 0.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 8.0F, -8.0F));
		PartDefinition cube_r1 = Bod.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(41, 38).addBox(-2.0F, -16.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(41, 38).addBox(14.0F, -16.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(41, 38)
						.addBox(14.0F, 0.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(41, 38).addBox(-2.0F, 0.0F, -5.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
