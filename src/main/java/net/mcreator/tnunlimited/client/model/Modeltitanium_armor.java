...
public class Modeltitanium_armor<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tnunlimited", "modeltitanium_armor"), "main");
	...
	public Modeltitanium_armor(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition bone = body.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -15.0F, 0.0F, 18.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition RightLeg = player.addOrReplaceChild("RightLeg",
				...
				PartPose.offset(-1.9F, -12.0F, 0.0F));
		PartDefinition LeftLeg = player.addOrReplaceChild("LeftLeg",
				...
				PartPose.offset(1.9F, -12.0F, 0.0F));
		PartDefinition LeftArm = player.addOrReplaceChild("LeftArm",
		...
		PartDefinition RightArm = player.addOrReplaceChild("RightArm",
				...
				PartPose.offset(-5.0F, -22.0F, 0.0F));
		PartDefinition Body2 = player.addOrReplaceChild("Body2",
		...
		PartDefinition Head2 = player.addOrReplaceChild("Head2",
