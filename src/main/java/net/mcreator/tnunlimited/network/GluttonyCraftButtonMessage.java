...
public class GluttonyCraftButtonMessage {
	...
	public GluttonyCraftButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GluttonyCraftButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GluttonyCraftButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
