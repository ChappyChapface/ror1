...
import net.mcreator.tnunlimited.procedures.DoublejumpOnKeyPressedProcedure;
...
public class DoublejumpMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TnunlimitedMod.addNetworkMessage(DoublejumpMessage.class, DoublejumpMessage::buffer, DoublejumpMessage::new, DoublejumpMessage::handler);
	}
}
