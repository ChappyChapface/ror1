...
public class Modelsporcerer<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sporcerer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 34)
						...
						.addBox(-8.0F, -9.0F, -8.0F, 16.0F, 2.0F, 16.0F, new CubeDeformation(0.75F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(40, 18).addBox(
				-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 18)
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(54, 0)
						.addBox(-5.4F, -1.1F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.75F)).texOffs(0, 0)
						.addBox(-6.4F, 2.9F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.75F)),
